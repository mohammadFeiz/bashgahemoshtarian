...
export default class Reward extends Component {
    ...
    details_layout() {
        let { details = ['بلیط رفت و برگشت', 'ترنسفر فرودگاهی'] } = this.props;
        return {
            column: [
                {
    ...
    rules_layout() {
        let { details = [
            {
                title: 'قوانین کنسلی', text: `
            در صورتی که کنسلی توسط شما در صورتی که پس از خرید جایزه و قبل از هماهنگی بلیط هواپیما و هتل توسط ادمین انجام شود، کل الماس پرداختی به حساب شما استرداد می شود.
در صورتی که کنسلی توسط شما پس از هماهنگی بلیط هواپیما و هتل انجام شود، هیچ الماسی به شما عودت داده نمی شود.
            `},
            {
                title: 'قوانین کنسلی', text: `
            در صورتی که کنسلی توسط شما در صورتی که پس از خرید جایزه و قبل از هماهنگی بلیط هواپیما و هتل توسط ادمین انجام شود، کل الماس پرداختی به حساب شما استرداد می شود.
...
در صورتی که کنسلی توسط شما پس از هماهنگی بلیط هواپیما و هتل انجام شود، هیچ الماسی به شما عودت داده نمی شود.
    ...
    comments_layout() {
        let { comments = [
            { name: 'پریماه ترکیان', type: 'خریدار', date: '1401/3/4', text: 'متن دیدگاه کاربر که ممکن است تجربه وی پس از خرید یا پیشنهادات او بر اساس دانش خود در مورد جایزه که می تواند شامل سفر، تخفیف ، کالا و .... را توصیف کند و با دیگران به اشتراک بگذارد که نظرات با لیبل خریدار و یا بازدید کننده تفکیک می شوند.' },
            { name: 'پریماه ترکیان', type: 'خریدار', date: '1401/3/4', text: 'متن دیدگاه کاربر که ممکن است تجربه وی پس از خرید یا پیشنهادات او بر اساس دانش خود در مورد جایزه که می تواند شامل سفر، تخفیف ، کالا و .... را توصیف کند و با دیگران به اشتراک بگذارد که نظرات با لیبل خریدار و یا بازدید کننده تفکیک می شوند.' },
            { name: 'پریماه ترکیان', type: 'خریدار', date: '1401/3/4', text: 'متن دیدگاه کاربر که ممکن است تجربه وی پس از خرید یا پیشنهادات او بر اساس دانش خود در مورد جایزه که می تواند شامل سفر، تخفیف ، کالا و .... را توصیف کند و با دیگران به اشتراک بگذارد که نظرات با لیبل خریدار و یا بازدید کننده تفکیک می شوند.' },
            { name: 'پریماه ترکیان', type: 'خریدار', date: '1401/3/4', text: 'متن دیدگاه کاربر که ممکن است تجربه وی پس از خرید یا پیشنهادات او بر اساس دانش خود در مورد جایزه که می تواند شامل سفر، تخفیف ، کالا و .... را توصیف کند و با دیگران به اشتراک بگذارد که نظرات با لیبل خریدار و یا بازدید کننده تفکیک می شوند.' },
            { name: 'پریماه ترکیان', type: 'خریدار', date: '1401/3/4', text: 'متن دیدگاه کاربر که ممکن است تجربه وی پس از خرید یا پیشنهادات او بر اساس دانش خود در مورد جایزه که می تواند شامل سفر، تخفیف ، کالا و .... را توصیف کند و با دیگران به اشتراک بگذارد که نظرات با لیبل خریدار و یا بازدید کننده تفکیک می شوند.' },
    ...
    render() {
        let { name = 'سفر به کیش',price = 15000, discountPercent = 12} = this.props;
        return (
            <RVD
                layout={{
